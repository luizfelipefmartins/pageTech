...
import { validRegister } from "../../validacion/validation";
  ...
  return (
    <>
      <form onSubmit={handleSubmit(submit)}>
        ...
        {errors.confirm ? <p className="error">{errors.confirm.message}</p> : null}
        ...
        {errors.course_module ? <p  className="error">{errors.course_module.message}</p> : null}
